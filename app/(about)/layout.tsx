...
const AboutLayout = ({ children }: { children: ReactNode }) => {
    return (
        <main suppressHydrationWarning>
            <nav className='flex-between bg-gradient-to-b from-light-600 to-light-200/50 backdrop-blur-3xl fixed z-50 w-full gap-5 p-6  shadow-light-700 shadow-lg border-b-1 border-valvent  sm:px-12'>
