...
import ImgUploader from '@/components/velventUI/ImgUploader';
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-2xl space-y-8">
        ...
        <div className="text-center space-y-4">
          <div>
            <h1 className="text-4xl font-bold tracking-tight text-velvent">Edit Profile</h1>
            <p className="text-gray-600 mt-2">Make changes to your profile</p>
          </div>
        </div>
        <Card className="border-0 shadow-2xl  bg-light-400">
          <CardHeader className="space-y-4 pb-8">
            <div className="text-center">
              <CardTitle className="text-2xl font-semibold text-velvent">Profile Card</CardTitle>
